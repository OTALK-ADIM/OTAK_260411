...
// 💡 기존 파일명에 맞춰 컴포넌트 이름을 WritePost로 설정했습니다.
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-6">
        ...
        <div className="flex justify-end gap-4 mt-2">
          ...
          <button 
            ...
            className="border-2 border-green-500 bg-black text-green-400 px-6 md:px-8 py-3 font-bold hover:bg-green-500 hover:text-black transition-none tracking-widest text-sm md:text-base"
          >
